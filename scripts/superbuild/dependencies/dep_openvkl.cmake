...
if (BUILD_OPENVKL_FROM_SOURCE)
  ...
  if (APPLE)
    set(OPENVKL_OSSUFFIX "${CMAKE_SYSTEM_PROCESSOR}.macos.zip")
  elseif (WIN32)
    set(OPENVKL_OSSUFFIX "sycl.x86_64.windows.zip")
  else()
  ...
  ExternalProject_Add(${COMPONENT_NAME}
    ...
    CONFIGURE_COMMAND ""
    BUILD_COMMAND ""
    INSTALL_COMMAND "${CMAKE_COMMAND}" -E copy_directory <SOURCE_DIR> ${COMPONENT_PATH}
    BUILD_ALWAYS OFF
  )
