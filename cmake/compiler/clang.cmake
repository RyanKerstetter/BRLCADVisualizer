...
if(OSPRAY_STRICT_BUILD)
  # Enable sane warnings
  set(OSPRAY_CXX_FLAGS "-Wextra ${OSPRAY_CXX_FLAGS}")
  ...
  set(OSPRAY_CXX_FLAGS "-Wno-switch-default ${OSPRAY_CXX_FLAGS}")
  ...
  set(OSPRAY_CXX_FLAGS "-Wno-cast-function-type-strict ${OSPRAY_CXX_FLAGS}") #ISPC exported functions casts
endif()
